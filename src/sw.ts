 ...
 *
 * Свой файл, а не собранный плагином: в нём будут напоминания (Р-14).
 ...
 *
 * Приём из «Поделиться» сюда не входит (Р-16): это обычная навигация,
 * и её отдаёт подмена навигации ниже. Разбор адреса — в `src/launch.ts`.
 */
